...
public class UserController {
    ...
    @ApiParam(value = "code" , example = "발급받은 인가코드" , required = true)
    public ResponseEntity<ResponseDto> modifyUserInfo(@AuthenticationPrincipal UserDetailsImpl userDetails , @RequestBody UserRequestDto.ModifyUser requestDto) throws Exception {
